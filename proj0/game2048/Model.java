...
public class Model extends Observable {
    ...
    public static boolean atLeastOneMoveExists(Board b) {
        ...
        for (int i = 0; i < size; i++) {
            for (int j = 0; j < size; j++) {
                ...
                if (i == size - 1) {
                    // the end of the col
                    if (hasSameValue(curr, b.tile(i, right))) {
                        return true;
                    }
                    continue;
                }
                ...
                if (j == size - 1) {
                    // the end of the row
                    if (hasSameValue(curr, b.tile(below, j))) {
                        return true;
                    }
                    continue;
                }

                if (hasSameValue(curr, b.tile(i, right)) || hasSameValue(curr, b.tile(below, j))) {
                    return true;
                }
            }
        }
    ...
    private static boolean hasSameValue(Tile a, Tile b) {
