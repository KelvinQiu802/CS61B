...
public class LinkedListDequeTest {
    ...
    public void testGet() {
        ...
        assertEquals(6, (int) l.get(5));
        assertNull(l.get(6));
        assertEquals(3, (int) l.getRecursive(0));
        assertEquals(4, (int) l.getRecursive(3));
        assertEquals(6, (int) l.getRecursive(5));
        assertNull(l.getRecursive(6));
    }
    ...
    public void equalsTest() {
        ...
        Deque<Integer> l3 = new ArrayDeque<>();
        for (int i = 0; i < 100; i++) {
            l.addLast(i);
            l2.addLast(i);
            l3.addLast(i);
